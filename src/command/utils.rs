...
pub fn is_gzipped(file_name: &PathBuf) -> Result<bool> {
...
pub fn file_reader(file_in: &Option<PathBuf>) -> Result<Box<dyn BufRead>> {
...
pub fn file_writer(file_out: &Option<PathBuf>) -> Result<Box<dyn Write>> {
...
/* 
pub fn file_writer_append(file_out: &PathBuf) -> Result<Box<dyn Write>> {
